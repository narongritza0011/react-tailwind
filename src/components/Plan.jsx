  ...
  return (
    <div className="max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4">
      ...
      <div className="flex flex-col h-full justify-center">
        <h3 className="text-2xl md:text-6xl font-bold">Plan Your Next Trip</h3>
        ...
        <p className="pb-6">
          ...
          sit ipsam nostrum voluptate consectetur illo id minus repellat
          delectus reiciendis, accusamus impedit sequi numquam molestias
          voluptatem laudantium, corrupti incidunt ea?
        </p>
        <div>
